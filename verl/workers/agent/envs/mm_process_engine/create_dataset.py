...
system_prompt = PROMPT.SYSTEM_PROMPT_V7
instruction_prompt = PROMPT.USER_PROMPT_V7
...
if __name__ == '__main__':
    ...
    parser.add_argument('--note', default='vaw_attribute_1t_fail_mh_v8')
    ...
    parser.add_argument('--env_name', default='visual_toolbox_v6')

...
EXPERIMENT_NAME=qwen_7b_instruct_high_user_bs256_no1treward
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent.user_model.level=high \
    actor_rollout_ref.rollout.agent.user_model.url='10.39.23.101' \

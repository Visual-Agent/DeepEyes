...
EXPERIMENT_NAME="visual_toolbox_grpo_qwenvl3b"
...
# VISUAL_DATASET_TRAIN=/fs-computility/mabasic/yangminghao/data/MinghaoYang/mmreasoning/vl_agent_V1_train_box.parquet
...
REF_MODEL_PATH=/fs-computility/mabasic/yangminghao/models/Qwen/Qwen2.5-VL-3B-Instruct

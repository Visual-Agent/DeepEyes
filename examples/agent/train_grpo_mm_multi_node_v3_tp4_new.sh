...
EXPERIMENT_NAME="visual_toolbox_v3_grpo_qwenvl7b_gpu16_tp4_no_tool_reward"

export SAVE_CHECKPOINT_DIR=/fs-computility/mabasic/yangminghao/project/VeRL-Agent/checkpoints
# export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues

VISUAL_DATASET_TRAIN=/fs-computility/mabasic/yangminghao/data/MinghaoYang/mmreasoning/vl_agent_V3_train_gqa_6k_new.parquet

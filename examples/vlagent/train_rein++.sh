...
PROJECT_NAME=vlagent_vx_think
EXPERIMENT_NAME=multiturn_gqa6k_0.8acc_-0.2format_0.4tool_rein++_ds4
BASE_MODEL=/cpfs/user/zhengziwei/HF_HOME/hub/models--Qwen--Qwen2.5-VL-7B-Instruct/snapshots/with_cot
VISUAL_DATASET_TRAIN=/cpfs/user/zhengziwei/workspace/agent/VeRL-Agent/data/vlagent/parquet/train_GQA_1t_fail_v3.parquet
VISUAL_DATASET_TEST=/cpfs/user/zhengziwei/workspace/agent/VeRL-Agent/data/vlagent/parquet/val_GQA_1t_fail_v3.parquet

...
def generation(task, meta, prompt_template, cot=False):
    ...
    if task['extra_info']['dataset'] == 'LeetCodeDataset':
        return None
...
def main(args):
    ...
    df = pd.read_parquet('data/code-r1/train-00000-of-00001.parquet')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_file', type=str, default="./data/code-r1/train-00000-of-00001.parquet")
    parser.add_argument('--output_file', type=str, default="./data/code-r1/qwen-7b-instruct/train-full.jsonl")
    ...
    parser.add_argument('--url', type=str, default="10.39.21.158")

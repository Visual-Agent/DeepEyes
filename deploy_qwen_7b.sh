...
# export MODEL_NAME='/cpfs/user/zhengziwei/workspace/agent/VeRL-Agent/checkpoints/agent_ppo_collab_code/qwen_7b_instruct_low_user/global_step_135/actor/hf_model'
# export SERVED_MODEL_NAME='qwen-7b-instruct-low-user'
